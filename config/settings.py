...
# SECURITY WARNING: keep the secret key used in production secret oh!
...
CSRF_TRUSTED_ORIGINS = ['https://web-production-ee0e.up.railway.app','https://enema.ng','https://www.enema.ng']
